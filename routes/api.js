...
var creatorList = ['@YusufRmdn','@Yusuf','@Yusuf-Spy','@SpyBot', '@YusufGanzz','@YusufNet','@YusufGGApi'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat gw aja yaaa di wa.me/62895704368804 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid, gak punya apikey? chat gw aja yaaa di wa.me/62895704368804 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'YusuFApi' && apikey != 'SpyBotApi' && apikey != 'ZBOTZApi') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if (apikeyInput != 'YusuFApi' && apikeyInput != 'SpyBotApi' && apikeyInput != 'ZBOTZApi') return res.json(loghandler.invalidKey)
